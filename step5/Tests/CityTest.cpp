...
public:
    ...
    int mNumBuildings = 0;
    virtual void VisitLandscape(TileLandscape* land) override{mNumLandscape++; }
    int mNumLandscape = 0;
    virtual void VisitGarden(TileGarden* garden) override{mNumGarden++; }
    int mNumGarden = 0;
...
TEST(CityTest, Visitor)
{
    ...
    ASSERT_EQ(1, visitor.mNumGarden) <<
